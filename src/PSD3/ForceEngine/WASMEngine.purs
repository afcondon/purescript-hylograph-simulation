...
-- | Usage:
-- | ```purescript
-- | import PSD3.ForceEngine.WASMEngine as WASMEngine
-- |
-- | main = do
...
-- | ```
module PSD3.ForceEngine.WASMEngine
  ( -- * Types
    WASMSim
  , WASMSimConfig
  , SimulationNode
...
import PSD3.ForceEngine.WASM as WASM
import PSD3.Scene.Engine (EngineAdapter)
import PSD3.Scene.Types (PositionMap, NodeRule)
...
applyFirstMatchingRule rules node =
  case Array.find (_.select >>> (_ $ node)) rules of
