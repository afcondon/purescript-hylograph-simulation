...
-- | Example:
-- | ```purescript
-- | import PSD3.ForceEngine.Setup (setup, manyBody, center, withStrength, static)
-- | import PSD3.ForceEngine.Setup.WASM as WASM
-- |
...
-- | ```
module PSD3.ForceEngine.Setup.WASM
  ( -- * Types
    WASMSim
...
import PSD3.ForceEngine.WASM as FFI
import PSD3.ForceEngine.Simulation (SimulationNode) as Exports
