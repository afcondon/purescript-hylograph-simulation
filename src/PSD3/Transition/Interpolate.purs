...
-- | Used with easing functions from PSD3.Transition.Tick to create
-- | smooth transitions.
-- |
-- | Usage:
-- | ```purescript
-- | import PSD3.Transition.Interpolate as I
-- | import PSD3.Transition.Tick (easeOutQuad, withEasing)
-- |
...
-- | ```
module PSD3.Transition.Interpolate
  ( -- * Point interpolation
    Point
  , lerpPoint
  , lerpPointXY
...
import PSD3.Transition.Tick (Progress, lerp, lerpInt)
