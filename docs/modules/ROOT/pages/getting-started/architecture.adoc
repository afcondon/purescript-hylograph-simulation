...
PSD3 Simulation is designed around a key insight: **force simulations are UI components**. Like any UI, they should integrate with your framework's state management rather than maintaining their own parallel state.
...
== The PSD3 Approach: Framework Owns State
