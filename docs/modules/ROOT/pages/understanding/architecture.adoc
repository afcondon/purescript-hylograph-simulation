= Architecture
:description: Internal architecture of PSD3 Simulation

This document explains how PSD3 Simulation is structured and how the components work together.
...
PSD3 Simulation uses D3's force calculation code via FFI but manages the simulation loop in PureScript:
