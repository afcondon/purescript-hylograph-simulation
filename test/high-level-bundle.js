...
(() => {
    ...
    return function(spec) {
      return function __do3() {
        ...
        write({
          ...
          consumers: append3(state3.consumers)([consumer]),
  ...
  var ensureManagerRegistered = function(ctx) {
    return function __do3() {
      ...
      return unless4(alreadyRegistered)(function __do4() {
  ...
  var renderWASMNodes = function(config) {
    return function(sim) {
      return function __do3() {
        ...
        return $$void5(renderTreeKeyed(container)(updateJoin("sim-nodes")(config.nodeElement)(nodes)(config.nodeTemplate)({
          enter: Nothing.value,
  ...
  var nodeTemplate = function(color) {
    return function(v) {
      return elem2(Circle.value)([attr("cx")(function(v1) {
        return v1.x;
      })(showNumD), attr("cy")(function(v1) {
        return v1.y;
      })(showNumD), attrStatic("r")("12"), attrStatic("fill")(color)]);
    };
  };
      ...
      return discard1(initWASM("./wasm-pkg/force_kernel.js"))(function() {
        return discard1(liftEffect3(log("WASM initialized!")))(function() {
          return liftEffect3(function __do3() {
            ...
            var d3Result = $$try(runSimulation({
              engine: D3.value,
            ...
            (function() {
              ...
              ;
              throw new Error("Failed pattern match at Test.HighLevelAPITest (line 82, column 5 - line 90, column 18): " + [d3Result.constructor.name]);
            })();
            log("Starting WASM simulation...")();
            var wasmResult = $$try(runSimulation({
              engine: WASM.value,
            ...
            (function() {
              ...
              ;
              throw new Error("Failed pattern match at Test.HighLevelAPITest (line 108, column 5 - line 116, column 18): " + [wasmResult.constructor.name]);
            })();
