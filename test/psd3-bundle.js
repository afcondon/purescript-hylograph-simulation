...
(() => {
  ...
  function link_default(links) {
    ...
    function initialize() {
      if (!nodes) return;
      var i, n = nodes.length, m = links.length, nodeById = new Map(nodes.map((d, i2) => [id3(d, i2, nodes), d])), link;
  ...
  function select_default(select7) {
    ...
    for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) {
      for (var group3 = groups[j], n = group3.length, subgroup = subgroups[j] = new Array(n), node, subnode, i = 0; i < n; ++i) {
        if ((node = group3[i]) && (subnode = select7.call(node, node.__data__, i, group3))) {
  ...
  function selectAll_default(select7) {
    ...
    for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) {
      for (var group3 = groups[j], n = group3.length, node, i = 0; i < n; ++i) {
        if (node = group3[i]) {
          subgroups.push(select7.call(node, node.__data__, i, group3));
          parents.push(node);
        }
      }
    }
  ...
  function data_default2(value12, key) {
    ...
    for (var m = groups.length, update2 = new Array(m), enter = new Array(m), exit = new Array(m), j = 0; j < m; ++j) {
      var parent2 = parents[j], group3 = groups[j], groupLength = group3.length, data = arraylike(value12.call(parent2, parent2 && parent2.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update2[j] = new Array(dataLength), exitGroup = exit[j] = new Array(groupLength);
      bind3(parent2, group3, enterGroup, updateGroup, exitGroup, data, key);
  ...
  function append_default(name15) {
    var create8 = typeof name15 === "function" ? name15 : creator_default(name15);
  ...
  function insert_default(name15, before) {
    var create8 = typeof name15 === "function" ? name15 : creator_default(name15), select7 = before == null ? constantNull : typeof before === "function" ? before : selector_default(before);
    return this.select(function() {
      return this.insertBefore(create8.apply(this, arguments), select7.apply(this, arguments) || null);
    });
  }
  ...
  var computeNodeGUP = function(currentNodes) {
    return function(desiredNodes) {
      var desiredIds = fromFoldable1(map4(function(v) {
        return v.id;
      })(desiredNodes));
      var exited = filter(function(n) {
        return !member3(n.id)(desiredIds);
      })(currentNodes);
      var currentById = fromFoldable22(map4(function(n) {
      ...
      var processed = map4(processDesired)(desiredNodes);
      var entered = map4(function(v) {
        return v.node;
      })(filter(function(v) {
        return v.isEnter;
      })(processed));
      var merged = map4(function(v) {
        return v.node;
      })(processed);
      var updated = map4(function(v) {
        return v.node;
      })(filter(function($97) {
        return !(function(v) {
          return v.isEnter;
  ...
  var computeLinkGUP = function(currentLinks) {
    return function(desiredLinks) {
      ...
      var desiredKeys = fromFoldable32(map4(linkKey)(desiredLinks));
      var currentKeys = fromFoldable32(map4(linkKey)(currentLinks));
  ...
  var applySetup = function(setupConfig) {
    return function(sim) {
      return function __do2() {
        ...
        var desiredNames = fromFoldable42(map4(function(v) {
          return v.name;
        })(setupConfig.forces));
      ...
      return function(sim) {
        ...
        if (sim.callbacks instanceof Just) {
          return for_1(alphaThresholds)(function(threshold) {
            return when2(crossedThreshold(prevAlpha)(newAlpha)(threshold))(function __do2() {
      ...
      return function(desiredLinks) {
        return function(sim) {
          return function __do2() {
            ...
            when3(currentCount !== newCount)(setNodeCount(sim.wasmSim)(newCount))();
  ...
  var ENDING = 5;
  var ENDED = 6;
  function schedule_default(node, name15, id3, index4, group3, timing) {
  ...
  function selectAll_default2(select7) {
    ...
    for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) {
      for (var group3 = groups[j], n = group3.length, node, i = 0; i < n; ++i) {
        if (node = group3[i]) {
          for (var children3 = select7.call(node, node.__data__, i, group3), child, inherit2 = get2(node, id3), k = 0, l = children3.length; k < l; ++k) {
    ...
    for (var groups = this._groups, m = groups.length, j = 0; j < m; ++j) {
      for (var group3 = groups[j], n = group3.length, node, i = 0; i < n; ++i) {
        if (node = group3[i]) {
          ...
          schedule_default(node, name15, id1, i, group3, {
  ...
  function transition_default2(name15) {
    ...
    for (var groups = this._groups, m = groups.length, j = 0; j < m; ++j) {
      for (var group3 = groups[j], n = group3.length, node, i = 0; i < n; ++i) {
        if (node = group3[i]) {
          schedule_default(node, name15, id3, i, group3, timing || inherit(node, id3));
        }
      }
    }
  ...
  function zoom_default2() {
    ...
    zoom.translateTo = function(selection2, x3, y3, p, event) {
      zoom.transform(selection2, function() {
        ...
        return constrain(identity7.translate(p0[0], p0[1]).scale(t.k).translate(
          typeof x3 === "function" ? -x3.apply(this, arguments) : -x3,
          typeof y3 === "function" ? -y3.apply(this, arguments) : -y3
        ), e, translateExtent);
      }, p, event);
  ...
  function applyHighlights(groupName, hoveredId, triggerElement, event) {
    const group3 = getHighlightGroup(groupName);
  ...
  function attachCoordinatedHighlight_(element) {
    return (identifyFn) => (classifyFn) => (groupName) => (tooltipContentFn) => (tooltipTrigger) => () => {
      ...
      sel.on("mouseenter.coordinated", function(event) {
        ...
        applyHighlights(group3, id3, element, event);
      });
      sel.on("mouseleave.coordinated", function(event) {
        clearHighlightsInGroup(group3);
      });
      return element;
    };
  }
          ...
          return function(v3) {
            if (v1 instanceof Node) {
              return function __do2() {
                ...
                var combinedChildMap = foldl2(union2)(empty2)(map8(snd)(childMaps));
      ...
      return function(v1) {
        ...
        if (v1 instanceof Join) {
          return function __do2() {
            ...
            var enterElements = map8(fst)(enterElementsAndMaps);
            var enterChildMaps = map8(snd)(enterElementsAndMaps);
        ...
        if (v1 instanceof NestedJoin) {
          return function __do2() {
            ...
            var elements = map8(fst)(elementsAndMaps);
            var childMaps = map8(snd)(elementsAndMaps);
              ...
              if (v1.value0.behaviors.enter instanceof Just) {
                ...
                (function() {
                  if (v1.value0.behaviors.enter.value0.transition instanceof Just) {
                    var enterElements2 = map8(fst)(rendered);
        ...
        ;
        if (v1 instanceof UpdateNestedJoin) {
          var innerData = join2(map8(v1.value0.decompose)(v1.value0.joinData));
          return function __do2() {
  ...
  var map9 = /* @__PURE__ */ map(functorMap);
      ...
      return function(v) {
        return function(tree) {
          return function __do2() {
            ...
            return map9(D3v2Selection_)(selectionsMap);
          };
        };
      };
    },
  ...
  var runFrame = function(v) {
    return function(timestamp) {
      return function __do2() {
        var state3 = read(v)();
        return when4(state3.running)((function() {
  ...
  // output/PSD3.Transition.Consumers/index.js
  ...
  // output/Test.PSD3VisualTest/index.js
  var discard3 = /* @__PURE__ */ discard(discardUnit);
  var show4 = /* @__PURE__ */ show(/* @__PURE__ */ showArray(showString));
  ...
  var renderTree3 = /* @__PURE__ */ renderTree(selectionMD3v2Selection_D)(/* @__PURE__ */ ordRecord()(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(ordRecordNil)()({
  ...
  var wasmForceSetup = /* @__PURE__ */ (function() {
    return setup("physics")([withStrength($$static(-80))(manyBody("charge")), withStrength($$static(1))(withY($$static(75))(withX($$static(350))(center("center"))))]);
  })();
  ...
  var simulationAST = function(color2) {
    return function(nodes) {
      var nodeTemplate = function(v) {
      ...
      return joinData("sim-nodes")("circle")(nodes)(nodeTemplate);
    };
  };
  ...
  var initialWASMNodes = [/* @__PURE__ */ mkNode(0)(350)(75)("1"), /* @__PURE__ */ mkNode(1)(360)(80)("2"), /* @__PURE__ */ mkNode(2)(340)(70)("3"), /* @__PURE__ */ mkNode(3)(355)(85)("4"), /* @__PURE__ */ mkNode(4)(345)(65)("5"), /* @__PURE__ */ mkNode(5)(365)(75)("6")];
  var setupWASMSimulationPSD3 = function(coord) {
    return function __do2() {
      log("Setting up WASM force simulation with SAME declarative API")();
      var sim = create3(initialWASMNodes)([])();
      var result = applySetupWithData2(wasmForceSetup)(initialWASMNodes)([])(sim)();
      log("  WASM Entered: " + show4(map10(function(v) {
        return v.label;
      })(result.nodes.entered)))();
      $$void5(runD3(bind1(select6("#wasm-sim-psd3"))(function(container) {
        return renderTree3(container)(simulationAST("#f97316")(initialWASMNodes));
      })))();
      register(coord)({
        tick: wasmConsumer(sim)(1e-3)(function __do3() {
          var currentNodes = getNodes2(sim)();
          return $$void5(runD3(bind1(select6("#wasm-sim-psd3"))(function(container) {
            return renderTree3(container)(simulationAST("#f97316")(currentNodes));
          })))();
        }),
  ...
  var initialD3Nodes = [/* @__PURE__ */ mkNode(0)(150)(75)("A"), /* @__PURE__ */ mkNode(1)(160)(80)("B"), /* @__PURE__ */ mkNode(2)(140)(70)("C"), /* @__PURE__ */ mkNode(3)(155)(85)("D"), /* @__PURE__ */ mkNode(4)(145)(65)("E"), /* @__PURE__ */ mkNode(5)(165)(75)("F")];
  var d3ForceSetup = /* @__PURE__ */ (function() {
    return setup("physics")([withStrength($$static(-80))(manyBody("charge")), withStrength($$static(1))(withY($$static(75))(withX($$static(150))(center("center"))))]);
  })();
  var setupD3SimulationPSD3 = function(coord) {
    return function __do2() {
      log("Setting up D3 force simulation with declarative applySetupWithData")();
      var sim = create(defaultConfig)();
      var result = applySetupWithData(d3ForceSetup)(initialD3Nodes)([])(sim)();
      log("  D3 Entered: " + show4(map10(function(v) {
        return v.label;
      })(result.nodes.entered)))();
      $$void5(runD3(bind1(select6("#d3-sim-psd3"))(function(container) {
        return renderTree3(container)(simulationAST("#06b6d4")(initialD3Nodes));
      })))();
      register(coord)({
        tick: simulationConsumer(sim)(1e-3)(function __do3() {
          var currentNodes = getNodes(sim)();
          return $$void5(runD3(bind1(select6("#d3-sim-psd3"))(function(container) {
            return renderTree3(container)(simulationAST("#06b6d4")(currentNodes));
          })))();
        }),
  ...
  var main = /* @__PURE__ */ launchAff_(/* @__PURE__ */ discard22(/* @__PURE__ */ liftEffect3(/* @__PURE__ */ log("PSD3 Visualization Test Starting...")))(function() {
    return discard22(liftEffect3(log("Demonstrating UNIFIED Setup API for D3 and WASM")))(function() {
      return discard22(liftEffect3(log("Initializing WASM force kernel...")))(function() {
        return discard22(initWasm2("./wasm-pkg/force_kernel.js"))(function() {
          return discard22(liftEffect3(log("WASM initialized!")))(function() {
            return liftEffect3(function __do2() {
              ...
              start3(coord)();
              return log("Both simulations running with unified Setup API!")();
            });
          });
        });
      });
